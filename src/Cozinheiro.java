class Cozinheiro {
    ...
    this.nome = gerarNomeCozinheiro();
}

private String gerarNomeCozinheiro() {
    int contadorA = 0;
    int contadorB = 0;
    int contadorC = 0;
    ...
    if (contadorA == 0) {
     ...
     for (Cozinheiro cozinheiro : listacozinheiros) {
        if (cozinheiro.nome.equals("Cozinheiro A")) {
            contadorA++;
        } else if (cozinheiro.nome.equals("Cozinheiro B")) {
            contadorB++;
        } else if (cozinheiro.nome.equals("Cozinheiro C")) {
            contadorC++;
        }
    }
}
